export const metadata = {
  ...
  description: "Complete configuration reference for Mail.configure() including providers, templates, queue, markdown, and failover settings.",
};
...
interface QueueConfig {
  ...
  prefix?: string;                      // Queue name prefix (default: 'laramail')
